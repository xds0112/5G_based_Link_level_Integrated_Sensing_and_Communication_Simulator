function [bsComResults, bsEstResults, bsEstRMSE] = singleCellSimulation(simulationTime, bsParams, topoParams, chlParams)
% Single ISAC-Cell Simulation
...
%%
    ...
    rdrEstParams = sensing.preProcessing.radarParams(nSlots,carrier,waveInfo,simLocal,topoLocal);
    ...
    for iSlot = 0:nSlots-1
        ...
        if simLocal.senService 
            ...
            elseif (slotType == "S")
                ...
                rdrRxGrid = sensing.monoStaticSensing(rdrTxGrid,carrier,waveInfo,simLocal,rdrEstParams,topoLocal);
