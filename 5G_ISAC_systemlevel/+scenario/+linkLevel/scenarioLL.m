...
bs = bs.updateParams(numUEs, tgtParams, tddPattern, specialSlot, antSize);
...
comChannel = bsParams.comChannelModel.channel;
nSlots     = numFrames*carrier.SlotsPerFrame;

% Pre-processing for link transmission
[harq,dlsch,newWtx] = preProcessing(pdsch,pdschExt,comChannel,carrier);
