%applyMultiUserChannels Apply CDL channels for MU-MIMO
%   [CHANNELS,RXDL,RXUL] =
%   applyMultiUserChannels(TDDPATTERN,SPECIALSLOT,CARRIER,SCHEDULE,CHANNELS,TXDL,TXUL)
...
function [channels,rxDL,rxUL] = applyMultiUserChannels(tddPattern,specialSlot,carrier,schedule,channels,txDL,txUL)
