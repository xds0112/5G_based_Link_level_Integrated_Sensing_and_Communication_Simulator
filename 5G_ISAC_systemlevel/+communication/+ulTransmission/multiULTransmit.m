%multiULTransmit Uplink transmitter for MU-MIMO
%   [TXUL,ACTIVE] = multiULTransmit(CARRIER,SRSs) performs uplink
...
function [txUL,active] = multiULTransmit(carrier,SRSs)
