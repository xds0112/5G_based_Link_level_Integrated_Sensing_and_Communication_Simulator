%prgInfo Precoding Resource Block Group (PRG) related information
%   INFO = prgInfo(CARRIER,BUNDLESIZE) provides information related to
...
function info = prgInfo(carrier,bundleSize)
