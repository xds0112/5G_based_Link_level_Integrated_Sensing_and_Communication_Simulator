%hMultiUserPDSCH PDSCH configurations for MU-MIMO
%   PDSCHs = hMultiUserPDSCH(NUMLAYERS) creates a multi-user set of PDSCH
%   configurations, PDSCHs. NUMLAYERS is a vector containing the number of
%   layers for each user.

% Copyright 2021 The MathWorks, Inc.

function PDSCHs = hMultiUserPDSCH(numLayers)
