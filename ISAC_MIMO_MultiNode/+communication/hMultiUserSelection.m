...
function [schedule,PDSCHs] = hMultiUserSelection(csi,tddPattern,specialSlot,carrier,PDSCHs,bsAntSize,alg)
    ...
    prgInfo = communication.hPRGInfo(carrier,PDSCHs(1).Extension.PRGBundleSize);
