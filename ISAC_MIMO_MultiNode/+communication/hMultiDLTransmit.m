...
function [txDL,singleLayerTBS] = hMultiDLTransmit(carrier,PDSCHs,bsAntSize)
    ...
    for ue = 1:numUEs
        ...
        [antSymbols,antIndices] = communication.hPRGPrecode(size(dlGrid),carrier.NStartGrid,symbols,indices,pdschExt.W);
        ...
        % Apply beamforming and map to the transmit grid
        [dmrsAntSymbols,dmrsAntIndices] = communication.hPRGPrecode(size(dlGrid),carrier.NStartGrid,dmrsSymbols,dmrsIndices,pdschExt.W);
