...
function [txDL,singleLayerTBS] = multiDLTransmit(carrier,PDSCHs,bsAntSize)
    ...
    for ue = 1:numUEs
        ...
        [antSymbols,antIndices] = communication.prgPrecode(size(dlGrid),carrier.NStartGrid,symbols,indices,pdschExt.W);
        ...
        % Apply beamforming and map to the transmit grid
        [dmrsAntSymbols,dmrsAntIndices] = communication.prgPrecode(size(dlGrid),carrier.NStartGrid,dmrsSymbols,dmrsIndices,pdschExt.W);
