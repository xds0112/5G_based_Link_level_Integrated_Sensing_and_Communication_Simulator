%multiUserSRS SRS configurations for MU-MIMO
%   SRSs = multiUserSRS(TDDPATTERN,SPECIALSLOT,CARRIER,NUMLAYERS) creates
...
function SRSs = multiUserSRS(tddPattern,specialSlot,carrier,numLayers)
