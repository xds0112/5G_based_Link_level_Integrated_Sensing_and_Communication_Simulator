%multiUserChannels CDL channel configurations for MU-MIMO
%   CHANNELS =
%   multiUserChannels(PROFILE,SPREAD,DOPPLER,BSANTSIZE,UEANTSIZES) creates
...
function channels = multiUserChannels(delayProfile,carrierFrequency,delaySpread,maximumDopplerShift,bsAntSize,ueAntSizes,topoParams)
    ...
    offsetsAoD = topoParams.azimuthUEs;
